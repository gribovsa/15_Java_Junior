...
/*
Функциональный интерфейс - интерфейс содержащий только один метод!!!
Лямбды работают только с функциональными интерфейсами!!!
Маркерный интерфейс - интерфейс не содержащий методов совсем
 */
@FunctionalInterface
//обязательно пишем нотацию, чтобы никто не испортил функциональный интерфейс, не добавил ещё один метод!!!
