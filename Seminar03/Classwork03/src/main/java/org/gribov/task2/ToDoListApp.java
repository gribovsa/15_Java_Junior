...
/**
 * Класс описывает задачу, которую мы решаем
 */
public class ToDoListApp {



    //файлы в которых будем сохранять наши данные
    ...
    //далее экземпляры классов фреймворка Jackson
    //ObjectMapper работает с json сериализацией
    private static final ObjectMapper objectMapper = new ObjectMapper();

    //XmlMapper работает с xml сериализацией
    ...
    /**
     * Метод сохранения задачи в файл
     * в зависимости от расширения файла (bin, json, xml) идёт в него сохранение
     * @param fileName
     * @param tasks
     */
    ...
    /**
     * Метод загрузки данных из файла (здесь идёт дессериализация данных)
     * @param fileName
     * @return
     */
    ...
    /**
     * Метод позволяющий пометить задачу как выполненная
     * @param scanner
     * @param tasks
     */
    ...
    /**
     * Метод просто выводит список задач на экран
     * @param tasks
     */
